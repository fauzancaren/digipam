...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?= base_url('asset/image/obi-erp/logo.png') ?>">
    ...
    <meta name="twitter:image" content="<?= base_url('asset/image/obi-erp/logonew.png') ?>" data-rh="true">
...
<style>   
    ...
    .footer {
        ...
        height:50%;
        z-index: -2;   
        background-image: url(<?= base_url("asset/image/obi-erp/bg-login.png") ?>);
...
<body>
    ...
    <section class="container text-center header">
        <div class="d-flex justify-content-center">
            <div class="logo">
                <img src="<?= base_url("asset/image/obi-erp/logowhite.png") ?>" width="50" height="50" class="d-inline-block align-top me-2" alt=""> 
            </div>
            <div class="title"> 
                ...
                <div class="card mt-4" style="box-shadow: 0px 0px 12px 0px #b1b1b1;border: none;width:22rem">
                    <div class="card-body " style="font-size:0.85rem">  
                        ...
                        <div class="d-flex justify-content-between ">
                            <a  href="<?= base_url("login/logout") ?>" class="btn btn-sm btn-link" style="font-size:0.85rem;text-decoration:none">Keluar</a> 
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        send_wa = function(){
			...
			$.ajax({
				method: "POST",
				dataType: "json",
				url: "<?= base_url("function/client_data_master/send_employee_whatsapp/"). $_sessionuser['MsEmpId'] ?>", 
				data:{
        ...
        send_email = function(){
			...
			$.ajax({
				method: "POST",
				dataType: "json",
				url: "<?= base_url("function/client_data_master/send_employee_email/"). $_sessionuser['MsEmpId'] ?>", 
				data:{
					datetime: endtime.format('YYYY-MM-DD HH:mm:ss')
				},
				success: function(data) { 
        ...
        $("#btn-wa-send-submit").click(function(){
			...
			$.ajax({
				method: "POST",
				url: "<?= base_url("function/client_data_master/success_employee_verify") ?>", 
				success: function(data) {
        ...
        $("#btn-wa-reg-submit").click(function(){  
			...
			$.ajax({
				method: "POST",
				url: "<?= base_url("function/client_data_master/update_employee_whatsapp") ?>",
				data: {
        ...
        $("#btn-email-reg-submit").click(function(){ 
           $(this).html('<i class="fas fa-circle-notch fa-spin"></i> Loading'); 
			...
			$.ajax({
				method: "POST",
				url: "<?= base_url("function/client_data_master/update_employee_email") ?>",
				data: {
					"MsEmpId":  "<?= $_sessionuser['MsEmpId'] ?>",
					"MsEmpEmail": StrEmail, 
				},
