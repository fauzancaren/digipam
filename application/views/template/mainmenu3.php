        ...
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="<?= base_url("client/tarif")?>" class="<?= $_menu == "Tarif" ? "active" : "" ?>">
                    ...
                    <h3>Kategori dan harga</h3>
                </a>
                <a href="<?= base_url("client/petugas")?>" class="<?= $_menu == "Petugas" ? "active" : "" ?>">
                    <span class="material-icons-sharp">
                    manage_accounts
                    </span>
                    <h3>Petugas</h3>
                </a>
                <a href="<?= base_url("client/pelanggan")?>" class="<?= $_menu == "Pelanggan" ? "active" : "" ?>">
                    <span class="material-icons-sharp">
                        person_outline
                    </span>
                    <h3>Pelanggan</h3>
                </a> 
                <a href="<?= base_url("client/info")?>" class="<?= $_menu == "Info" ? "active" : "" ?>">
                    <span class="material-icons-sharp">
                ...
                <a href="<?= base_url("client/pemakaian")?>" class="<?= $_menu == "Pemakaian" ? "active" : "" ?>">
                    <span class="material-icons-sharp">
                        opacity
                    </span>
                    <h3>Log Pemakaian</h3>
                ...
                <a href="<?= base_url("client/tagihan")?>" class="<?= $_menu == "Tagihan" ? "active" : "" ?>">
                    <span class="material-icons-sharp">
                        receipt
                    </span>
                    <h3>Tagihan</h3>
