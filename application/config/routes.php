...
$route['export/datasales/quotation/(:any)/(:any)'] = 'function/client_export_sales/quotation/$1/$2';
...
$route['export/datasales/sales/(:any)/(:any)'] = 'function/client_export_sales/sales/$1/$2';
$route['export/datasales/sales/(:any)/(:num)/(:any)'] = 'function/client_export_sales/sales/$1/$2/$3';
$route['export/datasales/payment/(:any)'] = 'function/client_export_sales/payment/$1';
$route['export/datasales/payment/(:any)/(:num)'] = 'function/client_export_sales/payment/$1/$2';
$route['export/datasales/payment/(:any)/(:num)/(:any)'] = 'function/client_export_sales/payment/$1/$2/$3';
...
$route['export/datasales/performa/(:any)/(:any)'] = 'function/client_export_sales/performa/$1/$2';
$route['export/datasales/performa/(:any)/(:any)/(:any)'] = 'function/client_export_sales/performa/$1/$2/$3';
